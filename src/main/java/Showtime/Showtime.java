...
import Showtime.util.GeneralUtils;
import Showtime.util.KeywordInfo;
import Showtime.util.TextureLoader;
...
@SpireInitializer
public class Showtime implements
    ...
    private static final String[] musicNames = {
        "Jules Gaia - Bop It",
        "Jamie Berry _ Octavia Rose - Delight",
        "Jules Gaia - Extravaganza",
    ...
    public static String PickRandomMusic() {
        return musicPath(musicNames[new Random().nextInt(musicNames.length)] + ".ogg");
    }

    public static String GetBlankMusic() {
        return musicPath("blank.ogg");
    }
    ...
    private static String checkResourcesPath() {
        String name = Showtime.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + Showtime.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(Showtime.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
